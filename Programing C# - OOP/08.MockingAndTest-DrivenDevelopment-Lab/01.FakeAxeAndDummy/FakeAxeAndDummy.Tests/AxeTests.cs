...
public class AxeTests
{
    ...
    public void DoAxeConstructorThrowExcetion_WhenAttackPointsAreBelowZero(int attackPointsBelowZero) => Assert.Throws<ArgumentOutOfRangeException>(() => new Axe(attackPointsBelowZero, this.durabilityPoints));

    [TestCase(-1), TestCase(-10)]
    public void DoAxeConstructorThrowExcetion_WhenDurabilityPointsAreBelowZero(int durabilityPointsBelowZero) => Assert.Throws<ArgumentOutOfRangeException>(() => new Axe(this.attackPoints, durabilityPointsBelowZero));
