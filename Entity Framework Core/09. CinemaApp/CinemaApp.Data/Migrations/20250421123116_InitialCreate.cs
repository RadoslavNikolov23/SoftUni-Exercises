    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false, comment: "The name of the Cinema"),
                    Location = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false, comment: "The location of the Cinema"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Shows if a cinema is Delete or Not")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false, comment: "The title of the movie"),
                    Genre = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false, comment: "The genre of the movie"),
                    ReleaseDate = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "The realse date of the movie"),
                    Director = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false, comment: "The name of the Director of the movie"),
                    Duration = table.Column<int>(type: "int", nullable: false, comment: "Duration of the movie"),
                    Description = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false, comment: "A small descrption of the movie"),
                    ImageUrl = table.Column<string>(type: "nvarchar(260)", maxLength: 260, nullable: true, comment: "Poster of the Movie"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Shows if the movie is Delete or Not")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvailableTickets = table.Column<int>(type: "int", nullable: true, comment: "Tracks remaining tickets for the movie in a specific cinema"),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Shows if the movie in the cinema is Delete or Not"),
                    Showtimes = table.Column<string>(type: "varchar(5)", unicode: false, maxLength: 5, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false, comment: "Ticket price for a movie"),
                    CinemaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
