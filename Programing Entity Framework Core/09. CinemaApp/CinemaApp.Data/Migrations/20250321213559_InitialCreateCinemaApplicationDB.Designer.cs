...
namespace CinemaApp.Data.Migrations
{
    ...
    [Migration("20250321213559_InitialCreateCinemaApplicationDB")]
    partial class InitialCreateCinemaApplicationDB
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Cinema", b =>
                {
                    ...
                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit")
                        .HasComment("Shows if a cinema is Delete or Not");

                    b.Property<string>("Location")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)")
                        .HasComment("The location of the Cinema");

                    b.Property<string>("Name")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)")
                        .HasComment("The name of the Cinema");
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.CinemaMovie", b =>
                {
                    ...
                    b.Property<int?>("AvailableTickets")
                        .HasColumnType("int")
                        .HasComment("Tracks remaining tickets for the movie in a specific cinema");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit")
                        .HasComment("Shows if the movie in the cinema is Delete or Not");
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Movie", b =>
                {
                    ...
                    b.Property<string>("Description")
                        ...
                        .HasComment("A small descrption of the movie");

                    b.Property<string>("Director")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)")
                        .HasComment("The name of the Director of the movie");

                    b.Property<int>("Duration")
                        .HasColumnType("int")
                        .HasComment("Duration of the movie");

                    b.Property<string>("Genre")
                        .IsRequired()
                        .HasMaxLength(60)
                        .HasColumnType("nvarchar(60)")
                        .HasComment("The genre of the movie");

                    b.Property<string>("ImageUrl")
                        .HasMaxLength(260)
                        .HasColumnType("nvarchar(260)")
                        .HasComment("Poster of the Movie");

                    b.Property<bool>("IsDeleted")
                        .HasColumnType("bit")
                        .HasComment("Shows if the movie is Delete or Not");

                    b.Property<DateTime>("ReleaseDate")
                        .HasColumnType("datetime2")
                        .HasComment("The realse date of the movie");
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Ticket", b =>
                {
                    ...
                    b.Property<decimal>("Price")
                        ...
                        .HasComment("Ticket price for a movie");
